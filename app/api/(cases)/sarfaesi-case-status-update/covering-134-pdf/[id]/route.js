// Application API route — SARFAESI 13(4) covering sheet PDF download.

/**
 * GET /api/sarfaesi-case-status-update/covering-134-pdf/:id
 *
 * Auth → load status update + child particulars → NCI/branch/unit → PDF buffer.
 * Drawing: lib/modules/sarfaesiCaseStatusUpdateCovering134Pdf.js
...
} from "../../../../../../lib/modules/sarfaesiCaseStatusUpdateCovering134Pdf";
...
export async function GET(req, { params }) {
  try {
    ...
    const buffer = await buildSarfaesiCovering134PdfBuffer({
      statusUpdate,
      nciRow,
      branchContext,
      signatoryName,
    ...
    const filename = safeSarfaesiCovering134PdfFilename(refNo || id);
    ...
    return jsonApiErrorForAction(e, "downloadPdf", { logLabel: "sarfaesi covering-134 pdf" });
  }
}

/**
 * One-off image pipeline: resize the recovery hero portrait into public/images/recovery-hero.png
 * for the login / marketing panel (sharp cover crop to fixed WIDTH x HEIGHT).
 *
 * Run: node scripts/dev/generate-recovery-hero.mjs
 * Requires the `sharp` package (dev/local tooling; not needed at Amplify runtime).
 */
import fs from 'fs';
...
/** Resize source portrait (or fallback) and write the public hero PNG. */
async function main() {

...
export default function TaskDetailFeedTabs({
  ...
  return (
    <section className="task-detail-block task-detail-feed">
      <div className="task-detail-feed-tabs" role="tablist" aria-label="Task feed">
        <button
          ...
          className={`task-detail-feed-tab${activeTab === "activity" ? " is-active" : ""}`}
        ...
        <button
          ...
          className={`task-detail-feed-tab${activeTab === "comments" ? " is-active" : ""}`}

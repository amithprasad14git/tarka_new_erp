 ...
 * Config: config/reports.js → report_region_wise_cumulative_report. See README.md#reports-frozen-framework.
 */
...
/** Safe quoted table names for region-wise cumulative joins. */
...
/**
 * Runs Region Wise Cumulative Report for the selected financial year.
 * @param {object} user
 * @param {Record<string, unknown>} filters

...
/** Safe quoted table names for audit log joins. */
...
/** SELECT audit trail rows with user display name. */
...
/**
 * Runs Audit Log Report for the selected date range and optional filters.
 * @param {object} user
 * @param {Record<string, unknown>} filters

...
/** Safe quoted table names for current AC transfer ledger joins. */
...
/** Detail SELECT for current-account transfer vouchers. */
...
/**
 * Runs Current AC Transfer Ledger for the selected month range.
 * @param {object} user
 * @param {Record<string, unknown>} filters

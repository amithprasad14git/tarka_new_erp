 ...
 * Config: config/reports.js → report_new_case_inward_register. See README.md#reports-frozen-framework.
 */
...
/** Safe quoted table names for case inward register joins. */
...
/** SELECT for case inward register rows with unit/bank/lookup labels. */
...
/**
 * Entrustment date range + optional NCI dimension filters.
...
/**
 * Runs New Case Inward Register for the selected entrustment date range.
 * @param {object} user
 * @param {Record<string, unknown>} filters

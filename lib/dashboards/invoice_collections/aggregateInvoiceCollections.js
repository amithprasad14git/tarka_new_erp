 ...
 * Powers KPI grid, by-bank pie, and drilldown modal. Guide: README.md#5a-landing-dashboards
 */
...
FROM ${invTable} inv
LEFT JOIN ${t.nci} nci ON nci.id = inv.caseNo
WHERE inv.billToUnit IN (${placeholders})

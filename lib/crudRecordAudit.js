 ...
 *
 * Timestamps are written as IST wall-clock strings ({@link formatInstantAsMysqlDatetimeIST}) so
 * they match Indian business time regardless of the host OS timezone.
 * =============================================================================
 */
...
export function stripClientAuditFields(body) {
  const out = { ...body };
  // Remove audit keys so clients cannot forge createdBy / modifiedDate.

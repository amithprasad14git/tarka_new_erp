...
/** Role 2 = unit-scoped operators for this module. */
...
/** Require Transaction Type Receipt or Payment. */
...
/** Require a known payment mode (card / cheque / cash / upi). */
...
/**
 * Role 2: unit must match session unit; npaCurrentAc must belong to that unit.
...
/**
 * Run all Loan Account validations before create/update.
 * @param {import("mysql2/promise").PoolConnection} conn

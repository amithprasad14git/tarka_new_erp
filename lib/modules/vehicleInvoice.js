...
/**
 * View grid: flag vehicle invoices that have a linked Invoices Received row.
 * @param {Record<string, unknown>[]} rows
 */
export async function enrichVehicleInvoiceListRows(rows) {
  ...
  const fkCol = mysql.escapeId("vehicleInvoice");

...
/**
 * Build Branch Copy PDF (triplicate bank letter pages) for one NCI case.
 * Called from the branch-copy-pdf API route.
 */
...
/** Download filename for Branch Copy PDF from case no. */

...
/** Loan Category label that Case No picker rows must match. */
...
/**
 * View grid: flag SARFAESI invoices that have a linked Invoices Received row.
 * @param {Record<string, unknown>[]} rows
 */
export async function enrichSarfaesiInvoiceListRows(rows) {
  ...
  const fkCol = mysql.escapeId("sarfaesiInvoice");

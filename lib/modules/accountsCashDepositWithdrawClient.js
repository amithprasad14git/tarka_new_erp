/**
 * accountsCashDepositWithdraw — browser-only behaviour (forms, pickers, Print/download).
 * Server save rules: lib/modules/accountsCashDepositWithdraw.js
 */
...
/**
 * Role 2: auto unit + npa Current AC from session / first account for unit; unit readonly.
 */
export function useAccountsCashDepositWithdrawClientModel({
  ...
  useEffect(() => {
    // Cash deposit/withdraw always needs NPA; unit operators get unit + default account on new rows.

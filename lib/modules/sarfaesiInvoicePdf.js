 ...
 *
 * Documentation:
 * - Module guide: README.md#sarfaesi-invoice-pdf
...
/** Centered invoice badge band (SARFAESI art, else recovery fallback); returns y after band. @returns {number} */
...
/**
 * Draws one full SARFAESI invoice page (logo → footer).
 * @param {PDFKit.PDFDocument} doc

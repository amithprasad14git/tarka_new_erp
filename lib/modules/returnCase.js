/**
 * Return Case — server rules. See README §7A and config/modules.js `return_case` block.
 * Case must be in "Returned" status; child rows need checkbox + return reason; FY freeze for role 2.
 */

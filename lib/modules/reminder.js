...
/** Allowed reminder_master.status values. */
export const REMINDER_STATUSES = ["Pending", "Completed", "Cancelled"];
/** Allowed reminder_master.recurrenceType values. */
...
/**
 * Insert a reminder activity-log child row (field change audit trail).
 * @param {import("mysql2/promise").PoolConnection} conn
 * @param {{ reminderId: number, fieldName: string, fromValue: unknown, toValue: unknown, changedBy: unknown }} ctx
 */
...
/**
 * Creator vs assignee field rules on reminder_master updates.
 * @param {{ user: object, oldRow: object, merged: object }} ctx
 */
...
/**
 * Shared before-write validation for reminder create and update.
 * @param {import("mysql2/promise").PoolConnection} conn
 * @param {{ user: object, merged: object, childTableRows?: object, oldRow?: object | null }} ctx
 */
...
/**
 * After create: seed activity log for the new reminder.
 * @param {import("mysql2/promise").PoolConnection} conn
 * @param {{ user: object, merged: object, insertId: number }} ctx
 */
...
/**
 * After update: log field changes and spawn next occurrence when completed.
 * @param {import("mysql2/promise").PoolConnection} conn
 * @param {{ user: object, oldRow: object, merged: object, id: number }} ctx
 */
...
/** Re-export child-table syncMode normalizer for reminder adapters. */

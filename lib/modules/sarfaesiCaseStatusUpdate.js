...
/** Matches `childTables[].key` for particulars lines. */
export const SARFAESI_CASE_STATUS_UPDATE_DETAILS_CHILD_KEY = "sarfaesi_case_status_update_details";
/** LoV query flag: Case No picker for this module only. */
...
/**
 * Domain rules before create/update (particulars, case uniqueness, FY freeze).
...
/**
 * CRUD beforeWrite entry for SARFAESI Case Status Update.
 * @param {import("mysql2/promise").PoolConnection} conn
 * @param {object} ctx
 */
...
/**
 * Stamp refNo after INSERT (SCSU/&lt;yearCode&gt;/#### pattern).
 * @param {import("mysql2/promise").PoolConnection} conn
